...
if (isset($_GET['eess_print_report'])) {
    ...
    if ($pe && ($is_admin || $is_sys_admin || $is_hr)) {
        ...
        <body onload="window.print()">
            ...
            <?php $emp_sch = get_user_meta($pe->ID, 'eess_school_name', true) ?: 'المدرسة الرئيسية'; ?>
            ...
            <div style="text-align: center; margin-bottom: 16px;">
                <h1 class="title" style="font-size: 16px; font-weight: 900; color: #0f172a; margin: 0; padding: 0;">الملف المهني والوظيفي المتكامل (EESS)</h1>
