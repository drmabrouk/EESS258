...
<div id="sm-global-violation-modal" class="sm-modal-overlay" style="display: none; position: fixed; inset: 0; background: rgba(15, 23, 42, 0.75); backdrop-filter: blur(6px); z-index: 999999; align-items: center; justify-content: center; padding: 15px;">
    <div class="sm-modal-content" style="max-width: 760px; width: 100%; background: #ffffff; border-radius: 20px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); overflow: hidden; border: 1px solid #e2e8f0; max-height: 90vh; display: flex; flex-direction: column;">
        <div id="sm-violation-modal-body" style="overflow-y: auto; padding: 0;">
